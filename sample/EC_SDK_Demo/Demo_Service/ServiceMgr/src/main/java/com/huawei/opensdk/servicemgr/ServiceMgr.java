...
public class ServiceMgr
{
    ...
    public boolean startService(Context context, String appPath)
    {
        ...
        if (isSupportIM)
        {
            ImMgr.getInstance().sdkInit(context);
        }
        return true;
    ...
    private int configServiceParam()
    {
        ...
        /* config ipt service param */
        IptMgr.getInstance().configIPTServiceParam();
