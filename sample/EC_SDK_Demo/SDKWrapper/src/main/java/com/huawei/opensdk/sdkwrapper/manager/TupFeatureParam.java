...
public class TupFeatureParam {
    ...
    /**
     * Support rich media message
     * 是否支持富媒体消息
     */
    private boolean isSupportRichMediaMessage;
     ...
     * @param isSupportCTD  CTD
     * @param isSupportIM   即时消息
     * @param isSupportRichMediaMessage 富媒体消息
     * @param isSupportAddressbook  地址本
     */
    public TupFeatureParam(int appType, boolean isSupportAudioAndVideoCall, boolean isSupportAudioAndVideoConf, boolean isSupportDataConf, boolean isSupportCTD, boolean isSupportIM, boolean isSupportRichMediaMessage, boolean isSupportAddressbook) {
        ...
        this.isSupportCTD = isSupportCTD;
        this.isSupportIM = isSupportIM;
        this.isSupportRichMediaMessage = isSupportRichMediaMessage;
     ...
     * @param isSupportAddressbook  地址本
     */
    public TupFeatureParam(boolean isSupportAudioAndVideoCall, boolean isSupportAudioAndVideoConf, boolean isSupportDataConf, boolean isSupportAddressbook) {
        this.isSupportAudioAndVideoCall = isSupportAudioAndVideoCall;
        this.isSupportAudioAndVideoConf = isSupportAudioAndVideoConf;
        this.isSupportDataConf = isSupportDataConf;
        this.isSupportAddressbook = isSupportAddressbook;
    ...
    public boolean isSupportCTD() {
        return isSupportCTD;
    }

    public void setSupportCTD(boolean supportCTD) {
        isSupportCTD = supportCTD;
    }
    ...
    public void setSupportIM(boolean supportIM) {
        isSupportIM = supportIM;
    }

    public boolean isSupportRichMediaMessage() {
        return isSupportRichMediaMessage;
    }

    public void setSupportRichMediaMessage(boolean supportRichMediaMessage) {
        isSupportRichMediaMessage = supportRichMediaMessage;
    }
