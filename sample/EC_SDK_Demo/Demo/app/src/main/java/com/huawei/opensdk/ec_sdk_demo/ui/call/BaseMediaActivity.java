...
//                final CallEventParams params;
//                if (obj instanceof CallEventParams)
//                {
//                    params = (CallEventParams) obj;
//                    isVideoCall = params.getCallType() == TupCallParam.CALL_E_CALL_TYPE.TUP_CALLTYPE_VIDEO;
//                }
//                else
//                {
//                    return;
//                }
//                mHandler.sendMessage(mHandler.obtainMessage(CALL_CONNECTED, isVideoCall));
