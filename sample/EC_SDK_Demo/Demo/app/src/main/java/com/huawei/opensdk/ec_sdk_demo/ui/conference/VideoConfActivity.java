...
import com.huawei.opensdk.ec_sdk_demo.logic.conference.mvp.DataConfVideoPresenter;
        ...
        implements IVideoConfContract.VideoConfView, View.OnClickListener
{
    ...
    {
        solution = LoginCenter.getInstance().getSolution();
        ...
        {
            return new DataConfVideoPresenter();
        }
    }
